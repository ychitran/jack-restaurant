            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    <div class="navbar-logo">
                        ...
                        <a href="?controller=admin&action=admin">
                        ...
                        <ul class="nav-right">
                            ...
                            <li class="user-profile header-notification">
                                ...
                                <ul class="show-notification profile-notification">
                                    ...
                                    <li class="waves-effect waves-light">
                                        <a href="?controller=auth&action=auth">
                            ...
                            <div class="pcoded-inner-navbar main-menu">
                                        ...
                                        <ul>
                                            <li class="more-details">
                                                ...
                                                <form action="" method="POST">
                                                    <a href="?controller=auth&action=auth"><i class=" ti-layout-sidebar-left"></i>Logout</a>
                                                </form>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <ul class="pcoded-item pcoded-left-item">
                                    <li class="pcoded-hasmenu">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class=" ">
                                                <a href="?controller=admin&action=user_list" class="waves-effect waves-dark">
                                            ...
                                            <li class=" ">
                                                <a href="?controller=admin&action=user_add" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                ...
                                <ul class="pcoded-item pcoded-left-item">
                                    <li class="pcoded-hasmenu">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class=" ">
                                                <a href="?controller=menuadmin&action=menu_list" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                    <span class="pcoded-mtext">List</span>
                                                    <span class="pcoded-mcaret"></span>
                                                </a>
                                            ...
                                            <li class=" ">
                                                <a href="?controller=menuadmin&action=menu_add" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                    <span class="pcoded-mtext">Add</span>
                                                    <span class="pcoded-mcaret"></span>
                                                </a>
                                ...
                                <div class="pcoded-navigation-label">OrderTable</div>
                                <ul class="pcoded-item pcoded-left-item">
                                    <li class="pcoded-hasmenu">
                                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i><b>BC</b></span>
                                            <span class="pcoded-mtext">OrderTable</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                        <ul class="pcoded-submenu">
                                            <li class=" ">
