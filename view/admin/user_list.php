        ...
        <tbody>
            ...
            function makeUserRow($user, $no = null)
            {
                return ' <tr class="">
                                    ...
                                    <td> <a href="?controller=admin&action=user_edit&userID=' . $user->userID . '" class="btn btn-dark">Edit</a>
                                    <form class="d-inline" onsubmit="return confirm(\'Do you want to remove ' . $user->username . '\')" action="?controller=admin&action=user_delete&userID=' . $user->userID . '" method="POST">
